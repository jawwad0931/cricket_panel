...
<body class="">
    <div class="container-fluid">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-6 col-sm-12 col-md-12" data-aos="slide-down" data-aos-duration="1500">
                <div class="card my-3 p-3">
                    <h6 class="">Batsman Rankings</h6>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">New Rank Batsman</h1>
                                ...
                                <div class="modal-body">
                                    <form action="signcode.php" method="post" class="row g-3 p-4 needs-validation"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="file" class="form-control" name="batsman_photo" id="validationCustom05" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="Batsman_name" id="validationCustom05" required>
                                            <div class="invalid-feedback">
        ...
        <div class="row mt-5 d-flex align-items-center justify-content-center shadow-div">
            <div class="col-lg-6 col-sm-12 p-2 bg" data-aos="fade-in" data-aos-duration="1000">
                        <?php
                        if (isset($_SESSION["bat_ranking"])) {
                            echo '
                            <script>
                                Swal.fire({
                                    text: "You clicked the button!",
                                    icon: "error",
                                    html: "' . $_SESSION["bat_ranking"] . '"
                                });
                            </script>
                            ';
                            unset($_SESSION['bat_ranking']);
                        }
                        ?>
