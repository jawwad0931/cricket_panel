    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-end" id="First_row">
            <div class="col-1 p-3" id="mySidenav">
                    <a href="batsman_career.php" class="btn btn-primary" id="back"><i class="ion-android-arrow-back"></i></a>
            </div>
            <div class="col-11 d-flex align-items-center p-4" id="user_login">
            <a href="admindash.php" class="text-light text-decoration-none fs-3">Update</a>
            </div>
        </div>
</body>
